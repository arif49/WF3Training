<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/3.2/widget-framework-core-module/widget-framework-core/src/main/webapp/template/framework/errorpages/401.jsp#1 $
...
<head>
  <title>401 Authorization Failed</title>
...
<div class="${wfCss.errorPage}">
  ...
  <p class="${wfCss.title}">Authorization Failed</p>

  <p>
    The requested content requires a username and password. To log in, please reload this page.
  </p>
</div>
</body>
