<%--
 * File           : $Header: //depot/escenic/widget-framework/branches/3.2/widget-framework-core-module/widget-framework-core/src/main/webapp/template/framework/errorpages/404.jsp#1 $
...
<div class="${wfCss.errorPage}">
  ...
  <p class="${wfCss.title}">Not Found</p>
